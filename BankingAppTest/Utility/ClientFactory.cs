...
namespace BankingAppTest.Utility
{
    ...
    {      
        ...
        {
            return new IndividualClient(MockProvider.GetIClientMock(active, created, deleted).Object, MockProvider.GetIPersonMock(dateOfBirth, deceased, firstName, lastName, pesel, nip).Object);
        }
        ...
        public static IndividualClient GetIndividualClient(DateTime? deleted = null,
            ...
            string firstName = "A", string lastName = "B", string pesel = "1", string nip = "1")
        {
            return new IndividualClient(MockProvider.GetIClientMock(active, DateTime.Now, deleted).Object, MockProvider.GetIPersonMock(DateTime.MinValue, deceased, firstName, lastName, pesel, nip).Object);
        }
